...
export async function GET(req: NextRequest, res: NextResponse) {
  ...
  // Email settings
  const toEmail = "support@onlineassignmentdesk.com"; // Change this to your admin email address
  // Send email
  if (paymentStatus === "true" && afterPaymentToken && OrderId) {
    try {
      ...
      if (emailSent) {
        ...
        return NextResponse.redirect("https://onlineassignmentdesk.com/thankyou-order");
      } else {
        console.error("Email sending failed");
        return NextResponse.redirect("https://onlineassignmentdesk.com/order");
      }
    } catch (error) {
    ...
    >
      ...
      <div style="text-align: center; margin-bottom: 10px; padding: 20px">
        ...
        >
          ...
          <a
            href="https://wa.me/+447593709971?text=Hello Online Assignment Desk Team, I need Academic Assistance. Could you help me complete my task on time?"
            style="
