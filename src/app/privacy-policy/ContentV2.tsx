...
export default function ContentV2() {
  ...
  return (
    <>
      ...
      <Head>
        <title>Privacy Policy | Onlineassignmentdesk.com</title>
        <meta
          name="description"
        ...
        <link
          rel="canonical"
          href={`https://onlineassignmentdesk.com/privacy-policy`}
        ></link>
      ...
      <div className="flex justify-between myContainer py-6 mx-auto md:gap-20 flex-col md:flex-row mb-10 max-md:px-4 mt-14 relative">
        <div className=" font-medium">
          ...
          <p className="text-[15px] leading-[24px] text-[#2A2A2A]">
            ...
            www.onlineassignmentdesk.com, its sub-domains, and its mobile application. For
            the purpose of explaining our privacy details, &apos;we,&apos;
            &apos;our,&apos; and &apos;us&apos; will be referred to as
            Onlineassignmentdesk.com, which operates this platform, and &apos;you&apos; will
          ...
          <ul className="text-[15px] leading-[24px] text-[#2A2A2A]">
            <li>
              ...
              contact us at support@onlineassignmentdesk.com to request removal from our
              mailing list.
            </li>
            <br />
            <li>
            ...
            <li>
              ...
              directly at support@onlineassignmentdesk.com with your request.
            </li>
            <br />
          </ul>
          ...
          <p className="text-[15px] leading-[24px] text-[#2A2A2A]">
            ...
            <a href="mailto:support@onlineassignmentdesk.com" className="text-blue-600">
