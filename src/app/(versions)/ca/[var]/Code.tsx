...
export default function Code(props: any) {
  ...
  return (
    <main>
      ...
      <link
        rel="canonical"
        href={`https://onlineassignmentdesk.com/ca/${slug}`}
      ></link>
      ...
      <OurServicesTest number={number} title={headder} region={"/ca"} />
      <WhyGoGradesTest
        country={country}
        city={city}
        title={headder}
...
bannerImageUrl="/random/5-Reasons-to-go-to-uni-besides-boosting-your-career-prospects.jpg"
        region={"/ca"}
      />
      <HowItWorksTest title={headder} region={"/ca"} />
      <FreeSampleTest country={country} title={headder} region={"/ca"} />
      <Footer number={number} region={"/ca"} title={headder} />
    </main>
  );
}
