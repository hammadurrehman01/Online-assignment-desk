// "use client";
// import { metalist, slugs } from "@/app/[var]/Code";
...
// import WhyOnline Assignment Desk from "@/components/WhyGoGrades";
...
//       let fetchedCity = locationData.country || "London";
...
//       console.log("location sAPI request fails");
//     }
//   };
...
//         key="desc"
//       />
//       <link rel="canonical" href={`https://onlineassignmentdesk.com/usa/${slug}`}></link>

//       <Herosection
//         title={headder as string}
//         country={country}
//         city={city}
//         number={number}
//         region={"/usa"}
...
//       />
//       <Trusted region={"/usa"} country={country} />
//       <WhyGoGrades
//         title={headder}
//         country={country}
//         city={city}
...
//         region={"/usa"}
//       />
//       <FreeSample country={country} region={"/usa"} />
//     </main>
//   );
// }
...
export default function Code(props: any) {
  ...
  return (
    <main>
      ...
      <TrustedTest country={country} region={"/usa"} />
      <OurServicesTest number={number} title={headder} region={"/usa"} />
      <WhyGoGradesTest
        country={country}
        city={city}
        title={headder}
      ...
      <CustomDivider
        ...
        region={"/usa"}
      />
      {/* <OurServicesTest number={number} region={"/usa"} /> */}
      <SubjectsTest
        country={country}
        city={city}
        title={headder}
      ...
      <CustomDivider
        ...
        region={"/usa"}
      />
      <HowItWorksTest title={headder} region={"/usa"} />
      <FreeSampleTest country={country} title={headder} region={"/usa"} />
