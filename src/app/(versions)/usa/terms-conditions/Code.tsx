...
export default function Code() {
  ...
  return (
    <>
      <title>Terms & Conditions | Onlineassignmentdesk.com</title>
      <meta
        name="description"
      ...
      <link
        rel="canonical"
        href={`https://onlineassignmentdesk.com/usa/terms-conditions`}
      ></link>
      ...
      <div className="border-b">
        <div className="w-full myContainer py-3 mx-auto max-md:px-4">
          <Link href="/usa/">Home</Link> {`> Terms & Conditions`}
        </div>
      </div>
      <div className="flex justify-between myContainer py-6 mx-auto md:gap-20 flex-col md:flex-row mb-10 max-md:px-4 mt-14 relative ">
        <div className=" font-medium">
          <p className="text-[15px] leading-[24px] text-[#2A2A2A] ">
            Thank You for visiting Online Assignment Desk and also for choosing us to satisfy
          ...
          <p className="flex justify-start  text-[15px] leading-[24px] text-[#2A2A2A] my-2">
            ...
            “Website” means onlineassignmentdesk.com
          </p>
          <p className="flex justify-start  text-[15px] leading-[24px] text-[#2A2A2A] my-2">
            <FaCheck className="text-[#33e533] text-[12px] mr-1  h-[15px] w-[15px] " />
          ...
          <p className="flex justify-start  text-[15px] leading-[24px] text-[#2A2A2A] my-2">
            <FaCheck className="text-[#33e533] text-[12px] mr-1  h-[15px] w-[15px] " />
            “We,” “Our” or “Company” means onlineassignmentdesk.com registered under the
            laws
          </p>
          <p className="flex justify-start  text-[15px] leading-[24px] text-[#2A2A2A] my-2">
            <FaCheck className="text-[#33e533] text-[12px] mr-1  h-[15px] w-[15px] " />
          ...
          <p className="flex justify-start  text-[15px] leading-[24px] text-[#2A2A2A] my-2">
            Online Assignment Desk is responsible for providing on-time delivery of ordered
        ...
        >
          ...
          <div className="flex flex-col justify-center items-center my-3 px-3">
            ...
            <Link
              href={"/usa/order?coupon=GG-50%off"}
