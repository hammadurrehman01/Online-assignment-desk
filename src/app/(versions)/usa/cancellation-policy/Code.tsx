...
export default function Code() {
  ...
  return (
    <>
      <title>Cancellation Policy | Onlineassignmentdesk.com</title>
      <meta
        name="description"
      ...
      <link
        rel="canonical"
        href={`https://onlineassignmentdesk.com/usa/cancellation-policy`}
      ></link>
      ...
      <div className="border-b">
        <div className="w-full myContainer py-3 mx-auto max-md:px-4">
          <Link href="/usa/">Home</Link> {`> Cancellation Policy`}
        </div>
      </div>
      <div className="flex justify-between myContainer py-6 mx-auto md:gap-20 flex-col md:flex-row mb-10 max-md:px-4 mt-14 relative ">
        <div className=" font-medium">
          <p className="text-[15px] leading-[24px] text-[#2A2A2A] ">
            Onlineassignmentdesk.com preserves all rights to drop your order any time under
