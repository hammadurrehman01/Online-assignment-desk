...
export default function page() {
  return (
    <>
      <title>Discounted Offers | Onlineassignmentdesk.com</title>
      <meta
        name="description"
        ...
        key="desc"
      />
      <link rel="canonical" href={`https://onlineassignmentdesk.com/usa/offers`}></link>
      ...
      <div className="bg-[#E84946] text-white flex justify-center items-center gap-20 relative max-md:pt-[80px] pt-[40px] px-[40px] pb-10">
        ...
        <div className="z-[2]">
          ...
          <Link href={`/usa/order?coupon=APP20`}>
