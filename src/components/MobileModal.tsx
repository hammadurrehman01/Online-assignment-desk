...
const MobileModal = (props: any) => {
  const { number, title, country, locationDetails, setModal } = props;
  ...
  return (
    <>
      <div className=" justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 h-screen  md:hidden ">
        <div className="relative w-auto my-6 mx-auto max-w-3xl ">
          <div className="py-4 my-5  flex overflow-auto ">
            ...
            <div className=" bg-white border-2 border-[#1a3e61]  scale-90">
              <div className="shadow-lg w-[100%] max-w-[400px]  rounded-md overflow-hidden lg:mt-[-20px] max-lg:mt-6 ">
                <div className="flex flex-col items-center  justify-center mt-3  bg-white pt-4">
                  ...
                  <h4 className="  text-[18px] capitalize text-center px-3 text-sm bg-blue-900 pt-1 pb-1  text-white font-medium rounded-md">
                ...
                >
                  <div className="flex justify-center items-center  text-lg font-bold capitalize">
                    {/* {displayTyperText} */} let's connect with our
                    Professors!
                  </div>
              ...
              <h3
                className="text-[20px]   text-white ml-4 cursor-pointer absolute   top-2 md:top-0 bg-red-500 px-2  rounded-full right-2 md:right-0"
      ...
      <div className="opacity-70 fixed inset-0 z-40 bg-black md:hidden block"></div>
    </>
  );
};
