...
export default function EveryStudentTest(props: any) {
  ...
  return (
    ...
    >
      ...
      <p className="text-white text-center max-w-3xl mx-auto ">
        From tight deadlines to complex topics, we provide fast, reliable, and
        affordable assignment solutions. Connect with us to experience
        hassle-free academic success.
      </p>
      <div className="flex justify-center gap-3 flex-wrap">
        <Link href={`${reg}/order?coupon=GG-50%off`}>
          <button
