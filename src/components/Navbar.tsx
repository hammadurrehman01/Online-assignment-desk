  ...
  return (
    <div className="">
      ...
      <div
        ...
        } fixed top-0 w-[100%] z-20 bg-white shadow-2xl border-b border-[#d8d8d8]`}
        // style={{ background: "linear-gradient(45deg, #f16700 35%, white 34%)" }}
      >
        <div
        ...
        >
          ...
          <div className=" text-black text-[18px] h-[100%]  min-[1000px]:flex hidden items-center">
            <Link
              href={`${reg}/#why-us`}
              className="px-[9px] hover:text-[#f16700] transition-all h-[100%] text-[14px]  py-[29px] "
              onClick={() => {
                setSideBar(false);
                setSideBar2(false);
              }}
            ...
            <h3
              className="px-[9px] hover:text-[#f16700] cursor-pointer transition-all h-[100%] text-[14px]  py-[29px] relative"
            ...
            <Link
              ...
              aria-label="Call"
              className="px-[9px] hover:text-[#f16700] transition-all h-[100%] text-[12px] flex items-center"
            >
