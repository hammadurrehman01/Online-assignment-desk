...
const CookiesPopupMobile = ({ setCookiePopup }: any) => {
  ...
  return (
    <div
      className={`block md:hidden  w-[300px] p-4 bg-[#003e72] fixed bottom-20 left-10 z-[999999] rounded-lg border-[1px] border-white ${
        shouldAnimateOut ? "swipe-box-right" : "swipe-box-left"
      }`}
    >
      <p className="text-white">
        Onlineassignmentdesk.com Uses Cookies to Ensure You Get the Best User Experience.
        Our Privacy Policy{" "}
        <Link
          href="/privacy-policy"
          target="_blank"
...
export default CookiesPopupMobile;
