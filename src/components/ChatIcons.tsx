  ...
  return (
    ...
    >
      <ul className=" ml-[10px]">
        ...
        >
          <Link href="mailto:support@onlineassignmentdesk.com">
        ...
        >
          <Link
            href={`sms:${number}?body=Hello Online Assignment Desk Team, I need Academic Assistance. Could you help me complete my task on time?`}
          >
