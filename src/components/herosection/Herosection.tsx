...
import openTawkToChat from "./tawkto";
...
export default function Herosection(props: any) {
  ...
  useEffect(() => {
    ...
    if (oldName && oldEmail && oldNumber) {
      ...
      setIsNumber(oldNumber as string);
    }
  }, []);
  ...
  useEffect(() => {
    ...
    localStorage.setItem("oldNumber", number);
  ...
  function getTitle(title: string) {
    if (!title) {
      return "Best Academic Consultancy";
